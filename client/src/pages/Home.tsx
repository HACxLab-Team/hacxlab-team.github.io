...
function Mark() {
  return (
    <img
      ...
      src="/manus-storage/hacxlab-logo_91e4f056.png"
      alt="HACxLab mark"
    />
  );
}
    ...
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section id="learning" className="learning-section">
          <div className="learning-image"><img src="/manus-storage/hacxlab-workshop_4cc83a6d.jpg" alt="Students collaborating during a humanities-centered AI workshop" /></div>
